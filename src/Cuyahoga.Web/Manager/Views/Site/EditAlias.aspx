...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
	<title>Cuyahoga Manager :: <%= String.Format(GlobalResources.EditSiteAliasPageTitle, ((Site)ViewData["Site"]).Name)%></title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphTasks" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphMain" runat="server">
	<h1><%= String.Format(GlobalResources.EditSiteAliasPageTitle, ((Site)ViewData["Site"]).Name)%></h1>
	<% using (Html.BeginForm("UpdateAlias", "Site", new { id = Model.Id }, FormMethod.Post, new { @id = "sitealiasform" })) { %>
		<fieldset>
			<ol>
				<li>
