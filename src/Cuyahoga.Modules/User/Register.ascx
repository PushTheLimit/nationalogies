<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Register.ascx.cs" Inherits="Cuyahoga.Modules.User.Register" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<asp:panel id="pnlRegister" runat="server">
	...
	<table>
		...
		<tr>
			<td></td>
			<td><asp:button id="btnRegister" runat="server" Text='<%# GetText("REGISTER") %>' onclick="btnRegister_Click"></asp:button></td></tr></table>
</asp:panel>
